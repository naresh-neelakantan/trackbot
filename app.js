    ...
    if (results && results.response) {
       ...
       // var list1 =[]
        ...
        //  thumbnail.title(results.response);
          thumbnail.images([builder.CardImage.create(session,"C:/Users/19242/Pictures/Swiss.PNG"),builder.CardImage.create(session,"C:/Users/Public/Pictures/Sample Pictures/girl-icon.jpg")]);
...
function LuisAjax(statement,session){
    ...
    request({  
        ...
        if(luisresult.topScoringIntent.intent=='Note.Search'){
            ...
            thumbnail.images([builder.CardImage.create(session,"C:/Users/19242/Pictures/Swiss.PNG")]);
